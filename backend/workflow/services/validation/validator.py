...
class WorkflowValidator:
    ...
    def validate(
        ...
        """
        Backward-compatible publish validation entry point.

        Existing WorkflowBuilderService and publish tests
        intentionally call WorkflowValidator.validate().
        """

        return WorkflowValidator.validate_workflow(
            workflow
        )