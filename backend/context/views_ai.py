...
from context.serializers_ai import AIIntelligenceSerializer
...
class AIIntelligenceAPIView(APIView):
    ...
    def get(self, request, organization_id):
        ...
        try:
            executive_dashboard = ExecutiveDashboardService().build(
            ...
            serializer = AIIntelligenceSerializer(result)
